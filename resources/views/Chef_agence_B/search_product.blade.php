        ...
        <div class="row clearfix">
            <div class="col-lg-12">
                    ...
                    <div class="body">
                            ...
                            <table id="DataTable" class="table table-hover m-b-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th data-breakpoints="sm xs md">Supprimer</th>
                                    </tr>
                                </thead>
                                <tbody id='tbody'>
                        ...
                        <script type="text/javascript">
                            ...
                            const searchValue = search.value;
                                ...
                                xhr.open('GET','{{route('search_stock')}}/?search=' + searchValue ,true);
                ...
                <a href="{{ route('agence_b.reception_produit') }}">
                    <button class="btn-hover color-11 button-dashboard">RECEVOIR UN PRODUIT</button>
                </a>
            </div>
        </div>
    </div>
