            ...
            <div class="col-lg-12 col-md-4 col-sm-12">
                <div class="card">
                    ...
                    <section class="ftco-section-2 ftco-degree-bg">
                        ...
                        <a href="/agence_b/list_product" style="width:100%;font-size:22px;color:#fff;" class="btn btn-default waves-effect waves-float waves-green"><i class="zmdi zmdi-assignment-return"></i>BACK</a>
                    </section>
                </div>
            </div>
        </div>
