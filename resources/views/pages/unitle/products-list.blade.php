            ...
            <div class="row">
                ...
                <div class="col-lg-5 col-md-6 col-sm-12">
                    <ul class="breadcrumb float-md-right">
                        ...
                        <li class="breadcrumb-item active">Produits Liste</li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <div class="card product_item_list">
                        <div class="body table-responsive">
                            <table class="table table-hover m-b-0">
                                ...
                                <tbody>
                                <tr>
                                    <td><img src="{{asset('images/ecommerce/1.png')}}" width="48" alt="Product img"></td>
                                ...
                                <tr>
                                    <td><img src="{{asset('images/ecommerce/10.png')}}" width="48" alt="Product img"></td>
                                ...
                                <tr>
                                    <td><img src="{{asset('images/ecommerce/11.png')}}" width="48" alt="Product img"></td>
                                ...
                                <tr>
                                    <td><img src="{{asset('images/ecommerce/5.png')}}" width="48" alt="Product img"></td>
                                ...
                                <tr>
                                    <td><img src="{{asset('images/ecommerce/6.png')}}" width="48" alt="Product img"></td>
                                    <td><h5>Simple Black Clock</h5></td>
                                ...
                                <tr>
                                    <td><img src="{{asset('images/ecommerce/2.png')}}" width="48" alt="Product img"></td>
                                ...
                                <tr>
                                    <td><img src="{{asset('images/ecommerce/3.png')}}" width="48" alt="Product img"></td>
                                    <td><h5>Simple Black Clock</h5></td>
