                            ...
                            <div class="row">
                                <div class="preview col-lg-4 col-md-12">
                                    <div class="preview-pic tab-content">
                                        <div class="tab-pane active" id="product_1"><img src="{{asset('images/ecommerce/1.png')}}" class="img-fluid" /></div>
                                        <div class="tab-pane" id="product_2"><img src="{{asset('images/ecommerce/2.png')}}" class="img-fluid"/></div>
                                        <div class="tab-pane" id="product_3"><img src="{{asset('images/ecommerce/3.png')}}" class="img-fluid"/></div>
                                        <div class="tab-pane" id="product_4"><img src="{{asset('images/ecommerce/4.png')}}" class="img-fluid"/></div>
                                        <div class="tab-pane" id="product_5"><img src="{{asset('images/ecommerce/5.png')}}" class="img-fluid"/></div>
                                    </div>
                                    <ul class="preview-thumbnail nav nav-tabs">
                                        <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#product_1"><img src="{{asset('images/ecommerce/1.png')}}" /></a></li>
                                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#product_2"><img src="{{asset('images/ecommerce/2.png')}}" /></a></li>
                                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#product_3"><img src="{{asset('images/ecommerce/3.png')}}" /></a></li>
                                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#product_4"><img src="{{asset('images/ecommerce/4.png')}}" /></a></li>
                                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#product_5"><img src="{{asset('images/ecommerce/5.png')}}" /></a></li>
                                    </ul>
                                </div>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="review">
                                    ...
                                    <ul class="row list-unstyled c_review">
                                        <li class="col-12">
                                            <div class="avatar">
                                                <a href="javascript:void(0);"><img class="rounded" src="{{asset('images/xs/avatar2.jpg')}}" alt="user" width="60"></a>
                                            </div>
                                        ...
                                        <li class="col-12">
                                            <div class="avatar">
                                                <a href="javascript:void(0);"><img class="rounded" src="{{asset('images/xs/avatar3.jpg')}}" alt="user" width="60"></a>
                                            </div>
                                            <div class="comment-action">
