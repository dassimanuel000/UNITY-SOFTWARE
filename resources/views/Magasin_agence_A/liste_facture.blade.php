        ...
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="card product_item_list">
                    <div class="body">
                        <h4>Les Factures Boucl&eacute;es</h4>
                        <h6>SAISSISSEZ LE NOM DU CLIENT OU L'IDENTIFIANT DE LA FACTURE</h6>
                            ...
                            <table id="DataTable" class="table table-hover m-b-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th data-breakpoints="sm xs">Date de reglement</th>
                    ...
                    <script type="text/javascript">
                        ...
                        const searchValue = search.value;
                            ...
                            xhr.open('GET','{{route('search_list_facture')}}/?search=' + searchValue ,true);
