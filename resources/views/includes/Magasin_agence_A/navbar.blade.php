        ...
        <div class="tab-pane stretchRight active" id="dashboard">
            <div class="menu">
                <ul class="list">
                    ...
                    <li class="@if(Route::currentRouteName() == 'state.index') active @endif"> <a href="{{route('state.index')}}" class=""><i class="zmdi zmdi-home"></i><span>Dashboard</span></a></li>
                    <li class="{{  'add_client' == request()->path() ? 'active open' : '' }} {{  'list_client' == request()->path() ? 'active open' : '' }}">
                        I
                    </li>

                    <li class="{{  'liste_facture' == request()->path() ? 'active open' : '' }}">
                        ...
                        <ul class="ml-menu dropdown-container">
                            <li class="{{  'liste_facture' == request()->path() ? 'link-dropdown' : '' }} {{  'liste_facture' == request()->path() ? 'link-dropdown' : '' }}"> <a href="{{route('liste_facture.index')}}">Les Factures Compl&heartsuit; tes</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
