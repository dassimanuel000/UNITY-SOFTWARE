            ...
            <div class="slim_scroll">
                <div class="card user_activity">
                    ...
                    <div class="streamline b-accent">
                        <div class="sl-item">
                            <img class="user rounded-circle" src="{{asset('images/xs/avatar4.jpg')}}" alt="">
                        ...
                        <div class="sl-item">
                            <img class="user rounded-circle" src="{{asset('images/xs/avatar5.jpg')}}" alt="">
                            <div class="sl-content">
                        ...
                        <div class="sl-item">
                            <img class="user rounded-circle" src="{{asset('images/xs/avatar6.jpg')}}" alt="">
                            <div class="sl-content">
                        ...
                        <div class="sl-item">
                            <img class="user rounded-circle" src="{{asset('images/xs/avatar7.jpg')}}" alt="">
                            <div class="sl-content">
