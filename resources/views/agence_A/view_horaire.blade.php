...
<section class="content ecommerce-page">
                    ...
                    <div class="body table-responsive shadow">
                        <div class="card-body card product_item_list responsive-mg-b-30 ">
                            <div class="panel-body center">
                                <center>
                                    <img src="{{asset('images/ecommerce/12.png')}}" class="img-circle center m-b img-responsive" width="" alt="User"/>
                                </center>
                                <br><br><br>
                                    ...
                                    <p class="m-b-0 margin10 padding p12">
                                        <center>
                                            <table style="text-align: center;">
                                                <th> Voir les Heures D'arrive et de Depart</th>
                                            </table>
                                        </center>
                                    </p>
                                </div>
                ...
                <div class="card product_item_list">
                    <div class="body">
                        <a href="{{route('agence_A.horaire.index')}}">
                            <button class="btn-hover color-9 button-dashboard">Back</button>
                        </a>
                    </div>
                </div>
            </div>
    ...
    <script type="text/javascript">
        ...
        const searchValue = search.value;
            ...
            xhr.open('GET','{{route('search_view_horaire')}}/?search=' + searchValue ,true);
