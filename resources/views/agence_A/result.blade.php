            ...
            <div class="col-lg-12">
                <div class="card product_item_list">
                    ...
                    <div class="body" id="results">
                        <h2>Produits Recherche </h2>

                        <div class="body">
                            <div class="alert alert-success">
                                @foreach ($result as $row)
                                Le produit se nommme {{ $row->title }}<br>
                                @endforeach
                            </div>
                        </div>
                        ...
                        <form method="get" action="{{ route('agence_A.live_search.search') }}"  id="searchForm">
                            ...
                            <div class="form-group">
                                <label class="col-md-4 control-label"> Les Produit</label>
                                <input type="text" name="live_search" id="live_search" class="form-control" placeholder="Rechercher un produit"/>
                    ...
                    <div class="body" id="results">
                        ...
                        <a href="/live_search" class="btn btn-default waves-effect waves-float waves-green"><i class="zmdi zmdi-assignment-return"></i><pre>BACK</pre></a>
                    </div>
                    @endif
                </div>
            </div>
